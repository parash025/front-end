...
if(up==fj)ConvivaStreamerProxy.nsi="PENDING";



if(up==fj)ConvivaStreamerProxy.QuW="IN_PROGRESS";




if(up==fj)ConvivaStreamerProxy.TgA="SUCCEEDED";



if(up==fj)ConvivaStreamerProxy.D4J="FAILED";




if(up==fj)ConvivaStreamerProxy.UhJ="INTERRUPTED";
...
OZ(up,"Ylo",jms);OZ(up,"GetStreamerStateManager",jms);
function jms(){
throw new Error("GetStreamerStateManager must be implemented in subclasses");
}


OZ(up,"Ukq",BmZ);OZ(up,"GetCapabilities",BmZ);
function BmZ(){
return ConvivaStreamerProxy.JV+ConvivaStreamerProxy.rgw;
}
...
OZ(up,"Zde",Kae);OZ(up,"GetMemoryPercent",Kae);
function Kae(){
return-1.0;
}
...
dN(up,ConvivaStreamerProxy,"FAILED",ConvivaStreamerProxy.D4J);
dN(up,ConvivaStreamerProxy,"INTERRUPTED",ConvivaStreamerProxy.UhJ);
dN(up,ConvivaStreamerProxy,"IN_PROGRESS",ConvivaStreamerProxy.QuW);
...
dN(up,ConvivaStreamerProxy,"PENDING",ConvivaStreamerProxy.nsi);
...
dN(up,ConvivaStreamerProxy,"SUCCEEDED",ConvivaStreamerProxy.TgA);
...
function YQT(jy){
return up.M9==jy.M9&&up.w6==jy.w6&&up._fK==jy._fK;
}
...
function ju(){
up.UQZ=new StreamInfo(-1,ConvivaContentInfo.jNU,ConvivaContentInfo._6t);
up.FvG=new Yw();
}
...
function apd(Uy){
if(Uy!=up.OjE&&up.Icw!=null){
up.Icw("PlayingStateChange",Uy);
}
up.OjE=Uy;
}
...
function ECq(TC8){
var Wiw=new StreamInfo(TC8,null,null);
up.cQi(Wiw);
}
...
function o3O(TRS){
var Wiw=new StreamInfo(-2,TRS,null);
up.cQi(Wiw);
}
...
function Iwf(eoy){
var Wiw=new StreamInfo(-2,null,eoy);
up.cQi(Wiw);
}
...
if(up.Icw!=null&&!up.UQZ.j5q(Wiw)){
up.Icw("StreamInfoChange",Wiw);
}
up.UQZ=Wiw;
}
...
function qEn(lNq){
if(up.Icw!=null&&lNq!=null){
up.Icw("ErrorChange",lNq);
}else{
up.FvG.Yb(lNq);
}
up.sOE=lNq;
...
function ZSP(UFr){
if(up.Icw!=null&&UFr!=null){
up.Icw("MetadataChange",UFr);
}
up.fDr=UFr;
}
...
if(up==fj)CO.HOB=500;
if(up!=fj)up.e7L=undefined;
if(up!=fj)up.flj=undefined;
...
var pq=Y_F.tc(2);
if(CO.TCw!=null){
return oL.ZLT(H1,pq,CO.TCw);
}else if(pq=="livepass.conviva.com"){
return oL.ZLT(H1,pq,"livepassdl.conviva.com");
}else if(pq=="livepass.staging.conviva.com"){
return oL.ZLT(H1,pq,"livepassdl.staging.conviva.com");
}
}
return H1;
}
...
up.e7L=Lt.b_(
function(){
ct.qF("LivePassConfigLoader","prefer primary time out");
up.flj=true;



if(up.Tko!=null&&up.Tko.X5!=null
&&up.Tko.jJd==null){
if(up.f9!=null&&up.f9.T8T==0){
ct.qF("LivePassConfigLoader","cancel loading the primary");
up.f9.wy();
}
CO.XyF=true;
ct.qF("LivePassConfigLoader","use the backup config");
up.oy5(up.Tko.X5);
}
},CO.HOB,"prefer primary time out");
...
if(up.Tko!=null&&up.Tko.T8T==0){
ct.qF("LivePassConfigLoader","cancel loading the backup");
up.Tko.wy();
}

if(up.flj==false&&up.e7L!=null){
Lt.Te(up.e7L);
up.e7L=null;
}
CO.XyF=false;
...
function(){
if(!up.sHG){
ct.qF("LivePassConfigLoader","loading the primary configuration failed");
...
up.f9.wy();
CO.XyF=true;
ct.qF("LivePassConfigLoader","use the backup");
}
}else{


ct.qF("LivePassConfigLoader","wait for the prefer primary timer to fire");
return;
}
up.oy5(fh.X5);
}else{
...
if(up==fj)Uj.tj=70;
if(up==fj)Uj.pb=0;
if(up==fj)Uj.ya=73996;


if(up==fj)Uj.bxs="Conviva LivePass version 2.70.0.73996";
...
if(_D.ZN&&CO.el().UZr("disableMonStats","value",false)){
_D.ZN=false;
}
...
if(y_.f5XG()<=0){
if(up.Jw!=null){
up.Jw(new D4u(up.oJ,up.Qc,new Yw()));
}
return;
}
...
var S5=new D4u(up.oJ,up.Qc,mpS);
up.Jw(S5);
up.Jw=null;
return;
}else{
...
&&Dh.xI("GetStreamerStateManager",I8P);
}
...
&&!Dh.xI("GetStreamerStateManager",X9e);
}
...
function Xd(w6,apN){
if(!up.Rf.Wt(w6)){
var kQ=up.jFg(w6,apN);
ct.qF(up.ww,"getResourceUsage(): Creating a new resource usage for resource \""+w6+"\" with ID "+kQ+".");
up.Rf.a9(w6,new dk(up,w6,kQ));
}
return up.Rf.tc(w6);
}
...
up.cvL=Dh.YB("GetStreamerStateManager",up.Du);



Dh.YB("SetMonitoringNotifier",up.cvL,
up.tso);
...
var oU8=Dh.YB("GetResource",up.cvL);
...
return(up.aC(NbJ,ConvivaStreamerProxy.Khw,GyG.Yhj)
==ConvivaStreamerProxy.Khw);
}
return true;
}
...
LK(up,"zSS",sh3);
function sh3(){
return "M["+up.aN.kQ+"]: MonitorConvivaStreamerProxy";
}
...
if(up!=fj)up.hGE=null;

function ju(G_,Bii){ConvivaStreamerProxy.call(up);
up.GjQ=G_;
up.hGE=new StreamerStateManager();
...
up.hGE.eco(IcH.i2y(up.aC(CBz,IcH.ft)));
}
...
up.hGE.cQi(new StreamInfo(X0T,FEG,JPe));
...
OZ(up,"GetStreamerStateManager",jms);
function jms(){
return up.hGE;
}
...
function lvV(k3,w6){
var KRi=up.hGE.M8p();
var ZTN=new StreamInfo(KRi.M9,KRi._fK,w6);
...
up.hGE.cQi(new StreamInfo(SlC,null,qSY));
}
